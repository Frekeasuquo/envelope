...
const AboutPage = () => {
    ...
    return (
        ...
        >
            {/* CONTAINER */}
            <div className="h-full overflow-scroll lg:flex bg-white dark:bg-gray-900 text-black dark:text-white" ref={containerRef}>
                {/* TEXT CONTAINER */}
                    ...
                    <div className="flex flex-col gap-12 justify-center pb-48" ref={experienceRef}>
                        ...
                        <motion.div 
                            ...
                            <div className="flex justify-between h-48 font-mono">
                                ...
                                <div className="w-1/3">
                                    <div className="bg-inherit p-3 font-semibold rounded-b-lg rounded-s-lg">
                                        ...
                                        {/* JOB COMPANY */}
                                            <div className=" rounded text-xs font-normal text-gray-400 w-fit">
                                                GOMYCODE   
                                            </div>
                            ...
                            <div className="flex justify-between h-48">
                                ...
                                {/* JOB TITLE */}
                                    <div className="bg-inherit p-3 font-semibold rounded-b-lg rounded-s-lg">
                                        <h1 className="font-mono rounded text-sm font-bold w-fit">Customer Support Representative</h1>

                                        <div className="block md:flex items-center gap-3">
                                        {/* JOB COMPANY */}
                                            <p className=" rounded text-xs font-normal text-gray-400 w-fit">
                                                EFFADEX INVESTMENT
                                            </p>
